...
const Footer = () => {
  ...
  <img
    src={Hotel}
    alt="Luxury Stay Hotel Logo"
    width="50"
    height="50"
  />
  <p>
    โรงแรมหรูหรา Luxury Stay
    <br />
    มอบความสะดวกสบายพิเศษ ตั้งแต่ปี 2005
  </p>
</aside>

      <nav>
        <h6 className="footer-title text-lg">เชื่อมต่อกับเรา</h6>
        <div className="grid grid-flow-col gap-4">
          ...
          <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="text-pink-500">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
      ...
      <div>
        <h6 className="footer-title text-lg">ติดต่อเรา</h6>
        <p>โทร: +1 (123) 456-7890</p>
        <p>อีเมล: contact@luxurystayhotel.com</p>
        <p>ที่อยู่: 1234 Main St, Cityville, ST 12345</p>
      </div>
    </footer>
  )
}
